...
//       <SortableContext items={posts.map(post => post._id)}>
...
//                   <Sortable key={post._id} id={post._id}>
//                     <tr className="border-b hover:bg-slate-700 cursor-pointer" onClick={(e) => e.stopPropagation()}>
...
//       {/* Optional: Drag overlay (optional visual for the item being dragged) */}
//       {/* <DragOverlay>
//         {activeId ? (
//           <div className="bg-slate-700 p-4 rounded-lg">
//             {posts.find((post) => post._id === activeId)?.title || 'Dragging...'}
//           </div>
//         ) : null}
//       </DragOverlay> */}
//     </DndContext>
